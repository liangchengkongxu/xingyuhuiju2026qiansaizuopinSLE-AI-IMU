...
cd "$APP_DIR"
mkdir -p "${WIDGET_REPLAY_DIR:-$APP_DIR/replays}"
...
# 单人练习 UI 多源去重 / 摄像头触发阈值
export WIDGET_PRACTICE_HIT_COOLDOWN_MS="${WIDGET_PRACTICE_HIT_COOLDOWN_MS:-0}"
export WIDGET_PRACTICE_CAM_STABLE_PERCENT="${WIDGET_PRACTICE_CAM_STABLE_PERCENT:-34}"
export WIDGET_PRACTICE_CAM_SWING_PERCENT="${WIDGET_PRACTICE_CAM_SWING_PERCENT:-30}"
...
export WIDGET_YOLO_SWING_FIRE_PERCENT="${WIDGET_YOLO_SWING_FIRE_PERCENT:-30}"
export WIDGET_YOLO_SWING_VEL="${WIDGET_YOLO_SWING_VEL:-0.08}"
export WIDGET_YOLO_SWING_PEAK="${WIDGET_YOLO_SWING_PEAK:-0.12}"
export WIDGET_YOLO_SWING_COOLDOWN_MS="${WIDGET_YOLO_SWING_COOLDOWN_MS:-600}"
...
# YOLOv8 Pose 人体骨骼（VPSS ch1 224 放大推理 + Region 画骨架）
...
export WIDGET_REPLAY_FPS="${WIDGET_REPLAY_FPS:-10}"
export WIDGET_REPLAY_VPSS_CHN="${WIDGET_REPLAY_VPSS_CHN:--1}"
